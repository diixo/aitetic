...
Person_names = [
    ...
    'Edward', 'Eleanor', "Elvis", 'Elizabeth', 'Emily', 'Emma', 'Eric', 'Ethan', 'Eve', 'Evelyn',
    'Frank', 'Frederick',
    ...
    'Rachel', "Randy", "Ralph", 'Raymond', 'Rebecca', 'Robert', 'Roger', 'Ronald', 'Ryan', "Ronny", "Ronnie", "Robin",
    'Samantha', 'Samuel', 'Sandra', 'Sarah', 'Scarlett', 'Scott', 'Sharon', 'Shirley', 'Sophia', 'Stephanie', 'Stephen', 'Steven', 'Susan', "Simon", "Simona",
    'Teddy', 'Terry', 'Theodore', 'Thomas', 'Tim', 'Timothy', 'Tina', 'Tom', 'Tyler', "Tony",
